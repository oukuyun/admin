...
return [
    ...
    'required_if'          => '當 :other 是 :value 時 :attribute 必須填寫。',
    'required_unless'      => '當 :other 不是 :values 時 :attribute 必須填寫。',
    'required_with'        => '當 :values 出現時 :attribute 必須填寫。',
    'required_with_all'    => '當 :values 出現時 :attribute 不能為空。',
    'required_without'     => '當 :values 留空時 :attribute field 必須填寫。',
    'required_without_all' => '當 :values 都不出現時 :attribute 必須填寫。',
